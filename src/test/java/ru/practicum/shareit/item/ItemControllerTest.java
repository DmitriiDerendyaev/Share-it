...
public class ItemControllerTest {
    ...
    private User user = new User(1L, "userName", "email");
    private boolean available = true;
    private ItemDto itemDto = new ItemDto(1L, "itemName", "itemDescription", true, 0L);
    private Item item = new Item(1L, "itemName", "itemDescription", true, user, null);
    private Item itemUpd = new Item(1L, "itemName2", "itemDescription2", true, user, null);
    private ItemDto itemUpdDto = new ItemDto(1L, "itemName2", "itemDescription2", true, 0L);
    ...
    BookingOwnerDto lastBooking = new BookingOwnerDto(1L, start1, end1, user.getId());
    BookingOwnerDto nextBooking = new BookingOwnerDto(2L, start, end, user.getId());
    ...
    public void updateItemTest() throws Exception {
        when(itemService.update(anyLong(), any(), anyLong())).thenReturn(itemUpdDto);
    ...
    public static String createItemForOunersJson(String name, String description, BookingOwnerDto lastBooking, BookingOwnerDto nextBooking, boolean available) {
        return "{\n" +
                "    \"name\": \"" + name + "\",\n" +
